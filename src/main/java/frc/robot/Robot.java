...
import frc.robot.subsystems.LiftingMechanism;
...
public class Robot extends TimedRobot {
  ...
  public void smartDashboard() {
    ...
    /*
    SmartDashboard.putNumber("Pigeon (intake) Angle", RobotMap.pigeonIntake.getAngle());
    SmartDashboard.putNumber("Pigeon (intake) Pitch", RobotMap.pigeonIntake.getPitch());
