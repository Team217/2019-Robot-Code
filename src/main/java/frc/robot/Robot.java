...
public class Robot extends TimedRobot {
    ...
    // public static final ClimbingSubsystem kClimbingSubsystem = new
    // ClimbingSubsystem();
    ...
    public void smartDashboard() {
        ...
        /*
        SmartDashboard.putNumber("Pigeon (intake) Angle",
        RobotMap.pigeonIntake.getAngle());
        SmartDashboard.putNumber("Pigeon (intake) Pitch",
        RobotMap.pigeonIntake.getPitch());
        
        SmartDashboard.putNumber("Left Drive Encoder",
        RobotMap.leftMaster.getPosition());
        SmartDashboard.putNumber("Right Drive Encoder",
        RobotMap.rightMaster.getPosition());
        
        SmartDashboard.putNumber("Left Elevator Encoder",
        RobotMap.leftElevator.getEncoder());
        SmartDashboard.putNumber("Right Elevator Encoder",
        RobotMap.rightElevator.getEncoder());
        
        SmartDashboard.putNumber("Right Arm Encoder",
        RobotMap.rightArm.getPosition());
        SmartDashboard.putNumber("Right Arm Encoder",
        RobotMap.rightArm.getPosition());
        
        SmartDashboard.putBoolean("Wrist Limit Front",
        RobotMap.wristFrontLimit.get());
        ...
        SmartDashboard.putBoolean("Elevator Bottom Limit",
        RobotMap.elevatorBottomLimit.get());
        SmartDashboard.putBoolean("Elevator Top Limit",
        RobotMap.elevatorTopLimit.get());
         */
