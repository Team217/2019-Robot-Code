...
public class LiftingMechanism extends Subsystem {
    ...
    /**
     * Checks if the elevator's limit switches are hit and sets the elevator speed
     * accordingly.
     * 
     * @param speed The speed value currently being sent to the elevator motors
     */
    /*
    ...
    */
    public void elevator(double speed) {
        // elevatorMaintainPID1.setPID(0.0001417, 0.00000117, 0); //not even close to
        // the right PID here
        /*
