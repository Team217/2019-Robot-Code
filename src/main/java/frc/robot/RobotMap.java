...
//    public static AnalogGyro intakeGyro = new AnalogGyro(intakeGyro_ID);
    ...
    public static final PID visionPID = new PID(0, 0.0000, 0.005, 100).setMinMax(-0.2, 0.2);
    public static final APID armAPID = new APID(new PID(0.18, 0.0006, 0, 100).setMinMax(-0.2, 0.2), 1.35);
